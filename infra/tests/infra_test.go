...
// TestResourceGroupExists verifies the resource group is provisioned.
...
// TestServiceBusResourcesExist verifies the Service Bus namespace exists.
...
// TestServiceBusMinionSubscriptions verifies all 5 minion subscriptions exist.
...
// TestStorageAccountExists verifies the storage account is provisioned.
...
// TestKeyVaultExists verifies the Key Vault is provisioned.
...
// TestTerraformPlanIsClean verifies no drift after apply.

...
// bot.test.js — unit tests for the Teams bot ACP client.
...
describe('sendToGoose', () => {
  ...
  test('rejects after 120 seconds without a response', async () => {
    ...
    //   flush 1: ensureSession resolves → sendToGoose sets 120s timer, calls sendACP
    //   flush 2: ack arrives → sendACP resolves, pending cleared before timer fires
